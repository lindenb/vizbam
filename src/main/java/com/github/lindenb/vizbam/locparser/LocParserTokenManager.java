/* Generated By:JavaCC: Do not edit this line. LocParserTokenManager.java */
...
/** Token Manager. */
public class LocParserTokenManager implements LocParserConstants
{
...
/** Constructor. */
public LocParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public LocParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
